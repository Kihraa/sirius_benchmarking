#!/usr/bin/env bash
# Sirius defaults, disk spill enabled (/tmp/sirius_spill), pipeline num_threads=4, multi-session.
set -euo pipefail
...
CONFIG="$BENCH_REPO/configs/default_spill_enabled/default_threads4.yaml"

OUT="$RUN_DIR/sweep_default_spill_enabled_threads4"
