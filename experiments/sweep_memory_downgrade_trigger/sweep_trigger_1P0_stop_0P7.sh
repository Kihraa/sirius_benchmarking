#!/usr/bin/env bash
# Baseline config, downgrade_trigger_fraction=1.0, downgrade_stop_fraction=0.7, single-session.
set -euo pipefail
...
CONFIG="$BENCH_REPO/configs/memory_downgrade_trigger/trigger_1P0_stop_0P7.yaml"

OUT="$RUN_DIR/sweep_trigger_1P0_stop_0P7"
