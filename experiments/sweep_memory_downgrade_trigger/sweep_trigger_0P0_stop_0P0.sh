#!/usr/bin/env bash
# Baseline config, downgrade_trigger_fraction=0, downgrade_stop_fraction=0, multi-session.
set -euo pipefail
...
CONFIG="$BENCH_REPO/configs/memory_downgrade_trigger/trigger_0P0_stop_0P0.yaml"

OUT="$RUN_DIR/sweep_trigger_0P0_stop_0P0"
