#!/usr/bin/env bash
# Baseline config, downgrade_trigger_fraction=0.5, downgrade_stop_fraction=0.35, single-session.
set -euo pipefail
...
CONFIG="$BENCH_REPO/configs/memory_downgrade_trigger/trigger_0P5_stop_0P35.yaml"

OUT="$RUN_DIR/sweep_trigger_0P5_stop_0P35"
