#!/usr/bin/env bash
# Baseline config, downgrade_trigger_fraction=0.95, downgrade_stop_fraction=0.67, single-session.
set -euo pipefail
...
CONFIG="$BENCH_REPO/configs/memory_downgrade_trigger/trigger_0P95_stop_0P67.yaml"

OUT="$RUN_DIR/sweep_trigger_0P95_stop_0P67"
