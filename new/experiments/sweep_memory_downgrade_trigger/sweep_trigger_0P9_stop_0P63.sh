#!/usr/bin/env bash
# Baseline config, downgrade_trigger_fraction=0.9, downgrade_stop_fraction=0.63, single-session.
set -euo pipefail
...
CONFIG="$BENCH_REPO/configs/memory_downgrade_trigger/trigger_0P9_stop_0P63.yaml"

OUT="$RUN_DIR/sweep_trigger_0P9_stop_0P63"
