#!/usr/bin/env bash
# Sirius defaults, disk spill enabled (/tmp/sirius_spill), pipeline num_threads=128, single-session.
set -euo pipefail
...
CONFIG="$BENCH_REPO/configs/default_spill_enabled/default_threads128.yaml"
